...
<body>
    ...
    <?php
        ...
        include("controller/eliminarclientes.php");
        ?>
                    ...
                    while ($datos = $sql->fetch_object()) { ?>
                        <tr>
                            ...
                            <td style="white-space: nowrap;">
                                <a href="modificar_registro.php?documento_identidad=<?= $datos->documento_identidad ?>"
                                    class="btn btn-small btn-warning" style="margin-right: 5px;"><i
                                        class="fa-solid fa-pen-to-square"></i></a>
                                <a onclick="return eliminar()"
                                    href="index.php?documento_identidad=<?= $datos->documento_identidad ?>"
